        ...
        <View style={styles.container}>
            <View style={[
                ...
                { 
                    ...
                    borderTopWidth: 1,
                    shadowOpacity: isDark ? 0 : 0.1, // Hide shadow in dark mode for cleaner look
                }
            ]}>
                            ...
                            >
                                ...
                                {isFocused && (
                                    <MotiView
                                        ...
                                        style={[styles.activeBlock, { backgroundColor: theme.primaryBtn }]}
                                    />
                                )}
                                ...
                                <IconComponent
                                    size={24}
                                    color={theme.ink}
                                    fill={isCart && hasCartItems ? theme.ink : "transparent"}
                                ...
                                {isCart && hasCartItems && !isFocused && (
                                    <View style={[styles.cartBadge, { borderColor: theme.ink }]} />
                                )}
                            </MotiView>
                        </Pressable>
                    );
...
const styles = StyleSheet.create({
    ...
    activeBlock: {
        ...
        zIndex: 1,
        bottom: -2,
        // Shadow will be handled by color style mostly
    },
    label: {
        position: 'absolute',
        bottom: -18, 
