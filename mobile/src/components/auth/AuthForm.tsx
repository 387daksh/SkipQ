...
export const AuthForm: React.FC<AuthFormProps> = ({ 
    ...
    const { promptAsync, response: googleResponse } = useGoogleAuth();
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                {/* Email Input */}
                <Animated.View style={getInputStyle('email')}>
                ...
                {/* Password Input */}
                <Animated.View style={getInputStyle('password')}>
            ...
            {/* Google Login Button */}
            {mode === 'login' && (
                <Animated.View entering={FadeInDown.delay(350).springify()} style={{ marginTop: SPACING.s }}>
                    <Pressable 
