...
export const AuthBottomSheet: React.FC<AuthBottomSheetProps> = ({
    ...
    const sheetHeight = height; // Dynamic height
    ...
    const panGesture = Gesture.Pan()
        ...
        .onUpdate((event) => {
            ...
            // Interpolate using specific sheetHeight
    ...
    // Safe render check - Removed to prevent "Reading from value during render" warning.
    // The sheet stays mounted but off-screen. pointerEvents handle interactions.
    ...
    return (
        <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
            ...
            <GestureDetector gesture={panGesture}>
                <Animated.View style={[styles.sheet, sheetStyle, { height: sheetHeight }, style]}>
                    {/* Drag Handle */}
