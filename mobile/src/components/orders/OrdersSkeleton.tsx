        ...
        <View style={[styles.container, { paddingTop: insets.top, backgroundColor: theme.background }]}>
            ...
            <View style={{ padding: SPACING.l, paddingBottom: SPACING.m }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Skeleton width={40} height={40} borderRadius={20} style={{ borderWidth: 2, borderColor: BORDER }} />
                </View>
            </View>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.section}>
                     ...
                     {/* Live Card */}
                     <Skeleton width="100%" height={100} borderRadius={12} style={{ borderWidth: 2, borderColor: BORDER, borderBottomWidth: 4, borderRightWidth: 4 }} />
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={{ flexDirection: 'row', gap: 8, marginBottom: SPACING.l }}>
                         {[1, 2, 3].map(i => (
                             <Skeleton key={i} width={70} height={32} borderRadius={16} style={{ borderWidth: 2, borderColor: BORDER }} />
                         ))}
                    </View>
                    ...
                    {[1, 2, 3, 4].map((i) => (
                        <View key={i} style={styles.row}>
                            ...
                            <View style={styles.timelineColumn}>
                                <Skeleton width={12} height={12} borderRadius={2} style={{ backgroundColor: BORDER }} />
                                <Skeleton width={2} height={60} borderRadius={0} style={{ marginTop: 4, backgroundColor: BORDER }} />
                            </View>
                            ...
                            <View style={[styles.card, { backgroundColor: CARD_BG, borderColor: BORDER }]}>
                                <View style={{ flexDirection: 'row', gap: SPACING.m }}>
                                    {/* Image */}
                                    <Skeleton width={60} height={60} borderRadius={8} style={{ borderWidth: 1, borderColor: BORDER }} />
