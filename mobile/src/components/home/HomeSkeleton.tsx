...
export const HomeSkeleton = () => {
    ...
    const BORDER_COLOR = isDark ? '#333' : GAME_UI.ink;
        ...
        <View style={[styles.container, { paddingTop: insets.top, backgroundColor: theme.background }]}>
            ...
            <View style={styles.headerSpacer}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: SPACING.s }}>
                    ...
                    <Skeleton width={48} height={48} borderRadius={24} style={{ borderWidth: 2, borderColor: BORDER_COLOR }} />
                </View>
                
                {/* Search Bar Placeholder */}
                <Skeleton width="100%" height={56} borderRadius={12} style={{ borderWidth: 2, borderColor: BORDER_COLOR }} />
            </View>

            <ScrollView contentContainerStyle={{ paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
                {/* Hero Section */}
                <View style={styles.section}>
                    <Skeleton width="100%" height={220} borderRadius={16} style={{ borderWidth: 2.5, borderColor: BORDER_COLOR, borderBottomWidth: 5, borderRightWidth: 5 }} />
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={{ flexDirection: 'row', gap: SPACING.s, overflow: 'hidden' }}>
                        {[1, 2, 3, 4].map((i) => (
                            <Skeleton key={i} width={100} height={38} borderRadius={8} style={{ borderWidth: 2, borderColor: BORDER_COLOR }} />
                        ))}
                    </View>
                </View>
                ...
                <View style={styles.section}>
                     ...
                     <Skeleton width="90%" height={160} borderRadius={16} style={{ borderWidth: 2, borderColor: BORDER_COLOR, borderBottomWidth: 4, borderRightWidth: 4 }} />
                </View>
                ...
                <View style={{ paddingHorizontal: SPACING.m }}>
                    {[1, 2].map((i) => (
                        <View key={i} style={{ marginBottom: SPACING.l }}>
                            ...
                            <View style={[styles.card, { backgroundColor: CARD_BG, borderColor: BORDER_COLOR }]}>
                                {/* Image Area */}
                                <Skeleton width="100%" height={140} borderRadius={0} style={{ borderBottomWidth: 2, borderBottomColor: BORDER_COLOR }} />
                                {/* Content Area */}
